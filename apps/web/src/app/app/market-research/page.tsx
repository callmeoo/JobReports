  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">市场调研</h1>
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            目标市场的挂牌结构、价格带、品牌车型与竞品平台观察。
          </p>
        </div>
        <Link
          href="/app/market-research/new"
      ...
      <div className="flex flex-wrap gap-2">
        <FilterLink href="/app/market-research" active={!country} label="全部" />
        {countryCodes.map((code) => (
          <FilterLink
            key={code}
            href={`/app/market-research?country=${code}`}
      ...
      <ContentList items={items} basePath="/app/market-research" />
    </div>
  );
}
